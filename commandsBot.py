...
class Commands(commands.Cog):
    ...
    def _play_song(self, ctx, song):
        ...
        ctx.voice_client.play(discord.FFmpegPCMAudio(song['formats'], executable=r'Utilitários\ffmpeg\bin\ffmpeg.exe', **FFMPEG_OPTIONS), after=lambda e:  self._next_song(ctx))
